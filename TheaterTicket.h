#ifndef THETICKETINGAPP_THEATERTICKET_H
#define THETICKETINGAPP_THEATERTICKET_H
...
public:
    // Constructors
    TheaterTicket();
    TheaterTicket(const char* type, int zone, int row);
...
#endif //THETICKETINGAPP_THEATERTICKET_H
